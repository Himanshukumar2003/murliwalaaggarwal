        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            <h3 className="text-2xl font-bold text-green-900 mb-6">
              Gallery Artisan keeps an open communication!
            </h3>
            <p className="text-gray-600  leading-relaxed mb-4">
              ...
              want to know more about our upcoming events, we welcome your
              inquiry.
            </p>
            ...
            <div className="space-y-4 border-t-2 border-green-500 pt-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-green-600">visit our Community</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <CardContent className="p-8">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-600">Art Collector</p>
                  </div>
                </div>
              </CardContent>
            </Card>
